...
import { Plus, Target, DollarSign, Calendar, CheckCircle2, Trash2 } from 'lucide-react';
...
export default function Goals({ goals, onCreateGoal, onDepositGoal, onDeleteGoal }) {
  ...
  const formatCurrency = (val) => `$${parseFloat(val).toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 2 })}`;
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginTop: '4px' }}>
            Set custom targets for major purchases, emergency funds, and future plans.
          </p>
        </div>
