...
import { TrendingUp, CheckCircle, ShieldAlert, AlertTriangle, Sparkles } from 'lucide-react';
  ...
  return (
    <div>
      ...
      >
        ...
        <div>
          <h2 style={{ fontSize: '1.25rem' }}>AI Financial Assistant & Health Advisor (INR 🇮🇳)</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginTop: '4px' }}>
            Automated intelligence analyzing your monthly income, spending velocity, budget variances, and savings trajectory in Rupees.
          </p>
        </div>
      </div>
          ...
          <div style={{ fontSize: '0.92rem', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
            ...
            {savingsRate >= 30 ? (
              <p style={{ marginTop: '8px', color: '#10b981' }}>
                🎉 Outstanding performance! You are saving over 30% of your total income ({formatCurrency((totalIncome * savingsRate) / 100)}). Consider moving excess funds to high-yield investment goals.
              </p>
            ) : savingsRate >= 15 ? (
